module.exports = function linkFlashCredit(sequelize, DataTypes) {
   ...
   */
  const FlashCredit = sequelize.define('flash_credit', {
    userid: {
  ...
  FlashCredit.associate = function associate(models) {
    ...
    // models.flash_credit.belongsTo(
    //   models.dibs_transaction,
    //   { as: 'transaction', targetKey: 'flash_credit_id', foreignKey: 'id' }
    // );
  };
