...
module.exports = function linkFriendReferrals(sequelize, DataTypes) {
    const FriendReferral = sequelize.define(
        'friend_referrals',
        {
            id: {
    ...
    //     FriendReferral.belongsTo(models.dibs_user, { foreignKey: 'userid', as: 'referringUser' });
    //     FriendReferral.belongsTo(models.dibs_user, { foreignKey: 'referredUserId', as: 'referredUser' });
    //     FriendReferral.hasMany(models.friend_referral_reminders, { foreignKey: 'friendReferralId', as: 'reminders' });
    //     FriendReferral.belongsTo(models.dibs_transaction, { foreignKey: 'referredTransactionId', as: 'referredTransaction' });
    //     FriendReferral.belongsTo(models.dibs_studio, { foreignKey: 'dibs_studio_id', as: 'studio' });
    // };
    ...
    FriendReferral.createNew = async function createNew({
        ...
        const [referral, created] = await FriendReferral.findOrCreate({
            where: {
                normalizedEmail,
                createdAt: {
            ...
            include: [
                {
                    model: this.sequelizer.models.dibs_user,
                    as: 'referringUser',
