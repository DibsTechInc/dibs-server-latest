 ...
 */
module.exports = async function getPacks({ userid, dibsStudioId, available }) {
    ...
    transactions = transactions.filter((t) => availabilityCondition(!t.stripe_refund_id && t.passPurchased.isValid()));
