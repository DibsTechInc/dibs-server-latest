...
class StripeClient {
        ...
        switch (currency) {
            ...
            case 'gbp':
                ...
                if (countryRegions[card.country.toUpperCase()] === 'Europe') {
                    this.stripeFeePercentage = GBP_EURO_CARD_STRIPE_FEE_PERCENTAGE;
                } else {
                    this.stripeFeePercentage = GBP_NON_EURO_CARD_STRIPE_FEE_PERCENTAGE;
                }
            ...
            default:
                 ...
                 */
                this.stripeFeePercentage = USD_STRIPE_FEE_PERECENTAGE;
                this.stripeFeeFixed = USD_STRIPE_FEE_FIXED;
        }
        return {
    ...
    retrieveBankAccounts(stripeAccountId) {
        console.log(`\n\n\nretrieving bank accounts now with this stripeAccountId: ${stripeAccountId}\n\n\n`);
        const externalaccounts = this.stripe.accounts.listExternalAccounts(stripeAccountId);
        console.log(`externalaccounts: ${JSON.stringify(externalaccounts)}`);
