 ...
 */
function findStudioCreditIndex(creditArray, studioId, source) {
 ...
 */
function findFlashCreditIndex(creditArray, studioId, source) {
  return _.findIndex(creditArray, o =>
 ...
 */
function getModifiedCharge(fullAmount, credit) {
 ...
 */
function getRemainingCredit(fullAmount, credit) {
...
module.exports = {
  findFlashCreditIndex,
  findStudioCreditIndex,
  getModifiedCharge,
  getRemainingCredit,
};
